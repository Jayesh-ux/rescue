...
import { doc, setDoc, getDoc, collection, addDoc, serverTimestamp, GeoPoint } from 'firebase/firestore';
        ...
        case 'hospital_admin':
          ...
          const hospitalDoc = await addDoc(collection(db, 'hospitals'), {
            ...
            location: new GeoPoint(
              hospitalAdminData.hospitalLocation.latitude,
              hospitalAdminData.hospitalLocation.longitude
            ),
